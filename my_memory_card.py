...
s_v = []
quest1 =  Question('как дела', "норм", "ты кто", "плохо", "не знаю")
s_v.append(quest1)
quest2 =  Question("кто ты", "человек", "кот", "обезьяна", "с какой целью интересуешься")
s_v.append(quest2)
quest3 =  Question("спишь?", "да", "нет", "я никогда не сплю", "мб")
s_v.append(quest3)
